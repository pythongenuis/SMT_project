...
print("++++++++++++++++++++++++++++++++++++++")
print("+                                    +")
print("+   Liste des fonctions de sécurité  +")
print("+                                    +")
print("++++++++++++++++++++++++++++++++++++++\n")
...
if str(line) == "sat":
    ...
    for L in range(1, len (list_strip_not_existant_element) + 1):
        for subset in itertools.combinations (list_strip_not_existant_element, L):
            ...
            if str(line) == "sat":
                print("RESULTAT: *** POUR SECURISER LE COMPOSANT APPLIQUER LES FONCTIONS ***")
                for el in subset:
                    print("not " + str (el))
            else:
                print("RESULTAT: *** CES FONCTIONS NE SECURISENT PAS LE COMPOSANT ***")
                for el in subset:
                    print("not " + str (el))
            mon_fichier.close()
